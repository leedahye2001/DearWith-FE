...
const Page = () => {
  ...
  const [luckyTags, setLuckyTags] = useState<string[]>([]);
  ...
  const getAllBenefits = (
    ...
    // 럭키드로우
    luckyTags.forEach((tag, i) =>
      all.push({
        name: tag,
        benefitType: "LUCKY_DRAW",
        dayIndex: 1,
        displayOrder: i + 1,
        visibleFrom: startDate,
      })
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const body = {
        ...
        benefits: getAllBenefits(basicTags, firstTags, luckyTags, startDate),
        organizer: {
          ...
          <div className="mt-4">
            {[
              ...
              },
              {
                ...
                value: luckyInput,
                tags: luckyTags,
                setValue: setLuckyInput,
                setTags: setLuckyTags,
              },
