...
export default function WriteTitle({ id, question, answer }: WriteTitleProps) {
  return (
    <div
      key={id}
      className="flex justify-start items-start mb-[16px] gap-[6px]"
    >
      ...
      <div className="flex flex-col justify-start items-start">
        <h2 className="text-text-5 text-[14px] font-[600]">{question}</h2>
